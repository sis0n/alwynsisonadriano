    ...
    <div className="bg-white dark:bg-[#050505] min-h-screen transition-colors duration-500 font-sans selection:bg-blue-500/30 relative text-slate-900 dark:text-slate-200 lg:cursor-none">
      ...
      <nav className="fixed top-0 w-full z-[70] px-6 py-6 flex justify-between items-center bg-white/80 dark:bg-[#050505]/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-900 transition-colors">
        ...
        <div className="hidden lg:flex items-center gap-10 text-[10px] font-black uppercase tracking-widest text-slate-400">
          ...
          <Link to="/blog" className={`hover:text-blue-600 transition-colors ${location.pathname.startsWith('/blog') ? 'text-blue-600' : ''}`}>
             Blog
          </Link>
        </div>
          ...
          <div className="fixed inset-0 z-[80] flex items-center justify-center p-6">
            ...
            >
              <div className="p-8 md:p-12">
                ...
                <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); closeHireModal(); alert('Message sent! (Demo only)'); }}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800 rounded-2xl py-4 px-6 text-sm focus:ring-2 ring-blue-600/20 outline-none transition-all dark:text-white"
                      />
                    </div>
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400">Opportunity Type</label>
                    <div className="grid grid-cols-2 gap-3">
                      {['Backend', 'Internship', 'Collab', 'Freelance'].map((type) => (
                        <label key={type} className="relative flex items-center justify-center p-3 rounded-xl border border-slate-100 dark:border-slate-800 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-900 transition-all group">
                          <input type="radio" name="opp_type" value={type.toLowerCase()} className="peer hidden" required />
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800 rounded-2xl py-4 px-6 text-sm focus:ring-2 ring-blue-600/20 outline-none transition-all dark:text-white resize-none"
                    />
                  </div>

                  <button 
                    type="submit"
                    className="w-full bg-blue-600 text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-3 hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20 group uppercase tracking-widest text-xs"
                  >
